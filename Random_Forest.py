...
# Initialize the ColumnTransformer to apply StandardScaler to numerical columns
ct = ColumnTransformer([
    ('scaler', StandardScaler(), numerical_cols)
], remainder='passthrough')  # 'passthrough' allows non-specified columns to remain untransformed

# Apply the ColumnTransformer to the data
scaled_data = ct.fit_transform(X)

# Convert the array back to a DataFrame (optional, for better readability)
